...
function GenericTable ()
{
    ...
    table += "<thead><tr><th>Projects</th><th>Publication date</th><th>Participants</th></tr></thead><tfoot></tfoot><tbody>";

    for(var i = 0; i < 30; ++i)
    {
        table += ("<tr><td><h3><a href='Project.html'>Build a Simple Website</a></h3>" +
        ...
        table += ("<tr><td><h3><a href='Project.html'>Online Mapping app project</a></h3>" +
        ...
        table += ("<tr><td><h3><a href='Project.html'>Write an iPhone application</a></h3>" +
